...
var z = setInterval(function() {elem.innerHTML = "<img src='./assets/catcoin1.png' height='15px'>" + numberWithCommas(money); Cookies.set("money",money);upc();if(isNaN(money)){window.money=0}else{savedatafound=true}}, 99);
...
function upc(){
  ...
  if(money > 100000000){
    ...
    aptxt.style.display="inline";
    aipbtn.style.display="inline";
  } else {
    console.log("ai pick isi availbr")
    return false;
  }
}
